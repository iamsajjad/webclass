 ...
 * Source https://codepen.io/franky/pen/LGMWPK
 */

var lColor = '#fefefe';
var pColor = ['#ce4025', '#fc7d26', '#fca226', '#fefefe'];
...
(function() {
  ...
  var Particle = function(parent, x, y) {
    ...
    this.radius = getLimitedRandom(1.5, 3.5);
    this.opacity = 0;
  ...
  var ParticleNetwork = function(parent) {
    this.options = {
      ...
      density: pDensity, // the lower the denser
      netLineDistance: lDensity,
      netLineColor: lColor,
      particleColors: pColor // ['#6D4E5C', '#aaa', '#FFC458' ]
    };
    this.canvas = parent.canvas;
    this.ctx = parent.ctx;
